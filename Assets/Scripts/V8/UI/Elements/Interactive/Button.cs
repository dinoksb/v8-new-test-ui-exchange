...
namespace V8
{
    public class Button : Frame
    {
        ...
        {
            if(!_pointerEnterEvents.Contains(eventAction))
        ...
        {
            if(!_pointerExitEvents.Contains(eventAction))
        ...
        {
            if(!_pointerDownEvents.Contains(eventAction))
        ...
        {
            if(!_pointerUpEvents.Contains(eventAction))
